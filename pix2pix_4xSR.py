...
def discriminator_lr(norm_type='batchnorm', target=True):
  ...
  down1 = downsample(128, 4, norm_type, False)(x)  # (bs, 32, 32, 128)
  down2 = downsample(256, 4, norm_type)(down1)  # (bs, 16, 16, 256)
...
def discriminator_hr(norm_type='batchnorm', target=True):
  """PatchGan discriminator model (https://arxiv.org/abs/1611.07004).
