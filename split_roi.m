...
outpath5 = '/home/hzhuge/Downloads/patches_code/stitch/test10/5x_overlap/';
outpath10 = '/home/hzhuge/Downloads/patches_code/stitch/test10/10x_overlap/';
outpath20 = '/home/hzhuge/Downloads/patches_code/stitch/test10/20x_overlap/';
outpath = '/home/hzhuge/Downloads/patches_code/stitch/test10/2x_stitch_overlap/';
...
global_shiftx_20= 17.31724229625895;
...
for m=60:80 %Start with 6 because of shift start position would be negative at 0, this can be increased to minimize white space
    for n=70:90
%m=70;n=85;
%     %5x patch 
    starty = 64*(n-1);  
...
%  	imwrite(img20x_patch,fullFileName)
       ...
       s=strcat('pair5&10','_',num2str(m),'_',num2str(n),'.png'); 
